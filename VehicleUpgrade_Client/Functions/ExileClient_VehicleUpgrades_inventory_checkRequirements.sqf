/*
        ...
        File Name: ExileClient_VehicleUpgrades_inventory_checkRequirements.sqf
...
*/
private["_vehicle","_vehicleClass","_requirements","_vehicleInventory","_result","_requiredItemClassName","_requiredItemCount","_itemCountInVehicle"];
_vehicle = _this;
